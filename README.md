...
pom.xml dosyasındaki bağımlılıkların yüklenmesini bekleyin (Maven Reload).
src/app/Main.java sınıfını çalıştırın.
Uygulama ilk açıldığında library.db veritabanı ve gerekli tablolar otomatik olarak oluşturulacaktır.
📋 Menü Kullanımı
